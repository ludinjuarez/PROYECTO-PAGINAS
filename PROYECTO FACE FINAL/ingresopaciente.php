					...
					<li>
						<figure>
							...
							<figcaption>
            					...
            					<a href="ingresopaciente.php"> servicios </a>
							</figcaption>
						</figure>|
					</li>
					<li>
                    ...
                    <div class="modal-header">
                     ...
                     <div class="modal-body">
                        ...
                        <form class="form-register" role="form">
                            ...
                            <p><input class="form-control" type="email" autofocus="" required="" placeholder="Correo Electronico"></input></p>
                            <p><input class="form-control" type="text" required="" placeholder="Asunto"></input></p>
                            

                      	<p><label>
                      	Estaremos contactandote 
                      	</label></p>
        ...
        <div class="modal-dialog">
             <div class="modal=content">
                <div id="servicio1" class="col-sm-6 col-md-6 col-lg-6 col-sm-offset-3 col-md-offset-3 col-lg-offset-3">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <center>Historial de Paciente</center>
                    </div> 
                    <div class="modal-body">
                       <center>
					     <img class="foto" src="Img/historial1.jpg" alt="img01" width="200" height="150">
                       </center>
					      <p><input class="form-control" type="text" autofocus="" required="" placeholder="Contraseña" ></input></p>
                			<center>
                				<button class="btn btn-default">Continuar</button>
                			</center>
          		    </div>
