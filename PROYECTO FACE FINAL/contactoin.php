...
<nav id="barratop" class="navbar navbar-default navbar-inverse"></nav>
            ...
            <div class="container" align="center" > 
                <div class="col-sm-6 col-md-4 col-lg-4 col-sm-offset-3 col-md-offset-4 col-lg-offset-4 "  style="margin-top: -10px;">
                    <h2 class="btn-primary" align="center" style="width:300px">Contacto</h2>     
   ...
   include "conexion.php";
    ...
    $Correo=$_POST['correo'];
    $Asunt=$_POST['asunto'];
    $query="INSERT INTO contacto (Nombre,Correo,Asunto) VALUES ('$Nombre','$Correo','$Asunt')";
 ...
 if($resultado>0){ ?>
                <h1>Error al Guardar Contacto</h1>
                <?php }else{ ?> 
                <h1>Contacto Guardado</h1>  
                    <p><label>
                        Estaremos contactandote muy pronto  <p size="10" class="text-info"> <?PHP echo "$Nombre";?> </p>
                  </label></p>
                <a href="index.php"> <input  id="aceptar"  type="submit" name="boton" value="inicio" class="btn btn-success" style="width:300px"/></a>  
